...
public class JFrmVenda extends JFrame {
	...
	public JFrmVenda() {
		...
		jMnlLote = new JMenuItem("Lote");
		jMnlLote.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JFrmLote frame = new JFrmLote();
	             frame.setVisible(true);
			}
		});
		jMnlLote.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_L, InputEvent.CTRL_MASK));
		jMnlLote.setFont(new Font("Arial Black", Font.BOLD | Font.ITALIC, 12));
		jMnCadastrar.add(jMnlLote);
		...
		jPnlValor.setBackground(Color.CYAN);
		jPnlValor.setLayout(null);
		jPnlValor.setBorder(new LineBorder(new Color(0, 0, 0), 2));
		jPnlValor.setBounds(10, 423, 360, 82);
		jContentPane.add(jPnlValor);
		
		jLblValor = new JLabel("Valor pago de R$");
		jLblValor.setHorizontalAlignment(SwingConstants.CENTER);
		jLblValor.setFont(new Font("Arial Black", Font.BOLD | Font.ITALIC, 16));
		jLblValor.setBounds(10, 17, 178, 43);
		jPnlValor.add(jLblValor);
		...
		jTxtValor.setBackground(Color.CYAN);
		jTxtValor.setBorder(new LineBorder(Color.BLACK, 2));
		jTxtValor.setBounds(198, 18, 149, 43);
		...
		jLblNumero.setBounds(31, 30, 128, 60);
		...
		jLblItem.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 2), 
						...
						new Font("Arial Black", Font.BOLD | Font.ITALIC, 15), null));
		jLblItem.setBounds(233, 30, 128, 60);
		...
		jLblValorP.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 2), 
		        		"Valor a pagar", TitledBorder.CENTER, TitledBorder.TOP,
						new Font("Arial Black", Font.BOLD | Font.ITALIC, 15), null));
		jLblValorP.setBounds(10, 351, 169, 60);
		jContentPane.add(jLblValorP);
		...
		jLblValorR.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 2), 
        		"Valor a receber", TitledBorder.CENTER, TitledBorder.TOP,
				new Font("Arial Black", Font.BOLD | Font.ITALIC, 15), null));
		jLblValorR.setBounds(189, 351, 172, 60);
		jContentPane.add(jLblValorR);
		...
		jPnlProduto.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 2), 
						...
						new Font("Arial Black", Font.BOLD | Font.ITALIC, 15), null));
		jPnlProduto.setBackground(Color.CYAN);
		jPnlProduto.setBounds(10, 107, 360, 231);
		...
		jLblValUnit.setBounds(22, 136, 311, 25);
		...
		jLblValItem.setBounds(23, 187, 311, 25);
		...
		jPnlQuant.setBackground(Color.CYAN);
		...
		jPnlVenda.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 2), 
				...
				new Font("Arial Black", Font.BOLD | Font.ITALIC, 15), null));
		jPnlVenda.setBackground(Color.CYAN);
		jPnlVenda.setBounds(10, 567, 486, 75);
		...
		jBtnIniciar.setBounds(16, 28, 86, 29);
		...
		jBtnIniciar.setBackground(Color.CYAN);
		jPnlVenda.add(jBtnIniciar);
		
		jBtnNovoItem = new JButton("Novo item");
		jBtnNovoItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				novoItem();
			}
		});
		jBtnNovoItem.setFont(new Font("Arial Black", Font.BOLD | Font.ITALIC, 15));
		jBtnNovoItem.setBorder(new LineBorder(new Color(0, 0, 0), 2, true));
		jBtnNovoItem.setBackground(Color.CYAN);
		jBtnNovoItem.setBounds(114, 28, 114, 29);
		jPnlVenda.add(jBtnNovoItem);
		
		jBtnFinalizar = new JButton("Finalizar");
		jBtnFinalizar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				finalizar();
			}
		});
		jBtnFinalizar.setFont(new Font("Arial Black", Font.BOLD | Font.ITALIC, 15));
		jBtnFinalizar.setBorder(new LineBorder(new Color(0, 0, 0), 2, true));
		jBtnFinalizar.setBackground(Color.CYAN);
		jBtnFinalizar.setBounds(240, 28, 114, 29);
		jPnlVenda.add(jBtnFinalizar);
		...
		jBtnCancelar.setBackground(Color.CYAN);
		jBtnCancelar.setFont(new Font("Arial Black", Font.BOLD | Font.ITALIC, 15));
		jBtnCancelar.setBounds(367, 28, 106, 29);
		...
		jPnlControle.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 2), 
				...
				new Font("Arial Black", Font.BOLD | Font.ITALIC, 15), null));
		jPnlControle.setBackground(Color.CYAN);
		jPnlControle.setBounds(599, 567, 448, 114);
		...
		jCmbFuncionario.setBackground(Color.CYAN);
		...
		jLbIFuncionario.setBounds(351, 28, 66, 25);
		...
		jLblIdentifica.setBounds(353, 63, 66, 25);
		...
		jPnlDebito.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 2),
				"Débito" , TitledBorder.CENTER, TitledBorder.TOP,
							new Font("Arial Black", Font.BOLD | Font.ITALIC, 15), null));
		jPnlDebito.setBackground(Color.CYAN);
		jPnlDebito.setBounds(132, 510, 117, 53);
		jContentPane.add(jPnlDebito);
		...
		jChkSim.setBounds(22, 17, 70, 25);
		jPnlDebito.add(jChkSim);
		
		jScrPListarItens = new JScrollPane();
		jScrPListarItens.setBorder(new LineBorder(Color.BLACK, 2));
		jScrPListarItens.setBounds(380, 30, 980, 509);
		       ...
		       switch (posi) {
		              case 0 : ind = jCmbProduto.getSelectedIndex();
	                                   if ( ind > -1) {
	                                       ...
	                                       jBtnNovoItem.setEnabled(true);
        	                           }       
	                                   break;
		             case 1 :  ind = jCmbFuncionario.getSelectedIndex();
                                       if (ind > -1) {
                                          o = listaF.get(ind);
	...
	private void preencheTabela() {
       ...
       for (int i = 0; i < listaI.size(); i++) { 
           ...
           Object[] linhas = 
                   new Object[]{NumberFormat.getInstance().format(i + 1),
	 ...
	 public void limpar() {
         ...
         JLabel lbl[] = { jLblCliente, jLblIdentifica, jLblNumero, jLblValorP, jLblValorR};
         for (JLabel l : lbl)
               l.setText("");
         JButton btn[] = {jBtnCancelar, jBtnFinalizar, jBtnIniciar,  jBtnNovoItem};
         for (JButton b : btn) {
             b.setEnabled(false);
         }
	 ...
	 public void iniciar() {
		   jFtdTxtCpf.setEnabled(true);
		   if (!Diversos.confirmar("Cliente possui cadastrado", titulo))
	   ...
	   jTblListarItens.setGridColor(Color.CYAN);
	   jTblListarItens.setBackground(Color.CYAN);
	   jTblListarItens.setForeground(Color.BLUE);
	  ControleGeral cVU = new ControleGeral(5);
    ...
    private void novoItem() {
          ...
          if ( ind > -1) {
             ...
             Produto p = (Produto) listaP.get(jCmbProduto.getSelectedIndex());
             i.setProduto(p);
             i.setQuantidade(Integer.parseInt(String.valueOf(jSpnQuant.getValue())));
             listaI.add(i);
             limparItem();
        	 ...
        	 Diversos.mostrarDados("Favor selecionar um produto", titulo, true);
    }
    
    private void finalizar() {
    	jTblListarItens.setEnabled(true);
         if (jLblNumero.getText().isEmpty() || jCmbFuncionario.getSelectedIndex() < 0 ||
        		   jTxtValor.getText().isEmpty()) {
               Diversos.mostrarDados("Favor preencher os campos", titulo,false);
         }      
         else if (listaI.size() > 0) {
    ...
    private void selecionarItem() {
        ...
        if (ind > -1) {
        	 ...
        	 resp += (iV.getVenda().getCliente().getNome() != null)?
        			 iV.getVenda().getCliente().getNome() : "não cadastrado";
        	 resp += "  atendido pelo(a) funcionario(a) "+ 
        			                                iV.getVenda().getFuncionario().getNome();
	...
	private void valorItem(int posi) {		
		if(posi > -1) {
		      ...
		      if (qt > e.getQuantidade()) {
		                Diversos.mostrarDados("Quantidade pedida é igual a " + qt +
		                    " sendo superior a quantidade estocada, que é igual a " +
	...
	private void pesquisa() {
          ...
          Object o = cPe.buscaCpf(cpf,0);
           if (o == null) 
               Diversos.mostrarDados("Cliente " + cpf + " não cadastrado", titulo, true);
           else {   
                    Pessoa p = (Pessoa) o;
