...
public class Diversos {
  ...
  public static boolean testaNum(String dado,String titulo) {
       ...
       try {
           ...
           "Digite apenas caracteres num�ricos " + erro.getMessage(), titulo, false);
            teste = false;
       }//Fim catch
      return(teste);
  }//Fim do testa num
  ...
  public static boolean checaCpf (String cpf) {
	  if (cpf.isEmpty() || cpf.length() != 11 || cpf == "00000000000" || 
	      ...
	      cpf == "99999999999" || cpf == "01234567890")
	          ...
	          System.out.println("1º digito verificador " + resto + " " + num);
	          if (resto != num) 
	           	  return false;
	          else {
	                  soma = 0;
	                 ...
	                 System.out.println("2º digito verificador " + resto + " " + num);
	                 if (resto != num) 
	        	         return false;
	          }
	  }        
  ...
  public static NumberFormat doisDigitos(int tipo) {
      ...
      doisDigitos = (tipo == 0) ? NumberFormat.getNumberInstance()  : //n�mero
