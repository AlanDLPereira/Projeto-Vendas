...
public class DaoProduto implements DaoBasico {
  ...
  public boolean incluir(Object o) {
      ...
      String inst="Insert into Produto";
             inst += "(Codigo, Descricao, grupo, PrecoU, Perecivel)";
             inst += "values(?, ?, ?, ?, ?)";
      try{
          Connection con = DaoConexaoAB.getInstancia().getCon();
          try (PreparedStatement pS = con.prepareStatement(inst)) {
  ...
  public boolean alterar(Object o) {
      boolean result = true;  
      Produto p = (Produto) o;
      String inst="Update Produto set Descricao = ?, Grupo = ?, PrecoU = ?, Perecivel = ?"; 
      inst += " where Codigo = ?";
      try{
          Connection con = DaoConexaoAB.getInstancia().getCon();
          try (PreparedStatement pS = con.prepareStatement(inst)) {
  ...
  public List<Object>carregaL() {
       String inst    ="Select * from Produto p"; // order by Descricao";
                   inst += "inner join Lote l on p.Codigo = l.Codigo and (Date)DataVal > GetDate() ";
       List<Object> lista = new ArrayList<>();
       ResultSet rS; 
       Object o;
       try{
